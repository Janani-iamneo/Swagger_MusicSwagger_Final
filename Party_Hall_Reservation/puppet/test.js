...
(async () => {
    ...
    // console.log(headers);
      if (headers[0] === 'Name' && headers[1] === 'Capacity' && headers[2] === 'Availability' && headers[3] ==='Action'){
  ...
  const page3 = await browser.newPage();
    ...
    {
    console.log('TESTCASE:Check_Successful_Navigation_to_PartyHall_Deleting_Page_and_Presence_of_h1_delete_cancel_Elements:success');
    }    
    else{
    console.log('TESTCASE:Check_Successful_Navigation_to_PartyHall_Deleting_Page_and_Presence_of_h1_delete_cancel_Elements:failure');
    }
